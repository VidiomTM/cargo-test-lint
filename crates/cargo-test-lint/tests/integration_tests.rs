...
"#,
    ...
    assert!(stderr.contains("CTL_ASSERT_MSG"), "stderr should contain CTL_ASSERT_MSG rule id");
}
...
"#,
    ...
    assert_eq!(sarif["version"], "2.1.0", "SARIF output version should be 2.1.0");
}
...
"#,
    ...
    assert!(code == 0 || code == 1, "exit code should be 0 or 1 without --deny-warnings");
}
